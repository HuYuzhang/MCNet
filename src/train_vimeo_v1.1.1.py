'''
This version derives from train_vimeo_v1.1
Now we don't condier the GAN, as we do in v1.1
But I find that when I just use the training loss, it is not good to measure if this model is good enough
